...
<div class="pt-24">
  <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
    ...
    <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
      <p class="uppercase tracking-loose w-full">sabes como esta tu empresa?</p>
      <h1 class="my-4 text-5xl font-bold leading-tight">
        Evalua Con Nosotros Y Obten Nuestra Ayuda!
      </h1>
      <p class="leading-normal text-2xl mb-8">
        La seguridad y la salud en el trabajo, incluyendo el cumplimiento de los requisitos en materia de SST con
        arreglo a las legislaciones nacionales, son responsabilidad y deber del empleador.
      </p>
...
{{-- este es el que le da la forma en onda azul --}}
<div class="relative -mt-1 lg:-mt-1">
    ...
    <div class="flex flex-wrap">
      <div class="w-5/6 sm:w-1/2 p-6">
        <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3">
          Facil uso de nuestra plataforma
        </h3>
        <p class="text-gray-600 mb-8">
          ...
          <img class="w-80 m-auto" src="{{ asset('img/svg1.svg') }}" alt="">
        </p>
      </div>
      ...
      <div class="w-full sm:w-1/2 p-6 mt-6">
        <div class="align-middle">
          ...
          <p class="text-gray-600 mb-8">
            ...
            <br />
            <br />
            <img class="w-80 m-auto" src="{{ asset('img/svg2.svg') }}" alt="">
          </p>
        </div>
      </div>
    </div>
